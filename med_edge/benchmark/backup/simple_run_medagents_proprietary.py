"""
Simple benchmark script for medagents-benchmark using proprietary models.
Combines medagents approach with proprietary models (OpenAI, Anthropic, etc.)
...
# ============================================================================
# All configs to run (excluding MedQA - use simple_run_proprietary.py for that)
ALL_CONFIGS = [
